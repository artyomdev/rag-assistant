"""
Core configuration for the RAG system (root file).
...
class Config:
    ...
    # For BGE‑Reranker: > 0 is very confident, > -4 is "possibly relevant".
    ...
    # --- PROMPTS ---
    SYSTEM_PROMPT: str = (
        "You are a senior assistant for internal product documentation. "
